...
const supportFooter = "\n\n*👾 Ada masalah?* Hubungi @Qiventorie untuk bantuan~";
...
Selamat datang di *Qiller WhatsApp Group* versi beta! ${getRandomKawaii()}

Aku akan membantu Senpai membuat grup WhatsApp kosong yang super kawaii! Pilih opsi di bawah untuk mulai ya~

_Jangan lupa join channel @Qiventory untuk tetap dapat akses!_${supportFooter}
  `,
...
_Akan kubuat pairing code untuk Senpai~ ${getRandomKawaii()}_${supportFooter}
  `,
...
_Jika terputus, akan ku-reconnect otomatis! Ganbarimasu~_ (ง •̀\\_•́)ง${supportFooter}
  `,
...
_Coba lagi nanti ya, Senpai!_ (╯°□°）╯︵ ┻━┻${supportFooter}
  `,
...
_Contoh: Jika nama "Qiller", akan dibuat "Qiller 1", "Qiller 2", dst._
...
_Coba kirim nama yang lebih singkat ya~_ (・ω<)☆${supportFooter}
      `;
    } else {
      return `
*⚠️ Nama Grup Invalid!*
...
_Coba nama yang lebih simple, Senpai~_ (・ω<)☆${supportFooter}
      `;
    }
  },
...
_Coba lagi, Senpai~_ (≧◡≦)${supportFooter}
      `;
    } else {
      return `
*💢 Jumlah Invalid!*
...
_Coba kirim angka yang valid ya~_ (≧◡≦)${supportFooter}
      `;
    }
  },
...
_Gomennasai! Akan terus mencoba grup lainnya~_ (╥﹏╥)${supportFooter}
  `,
...
*Ada masalah dengan grupnya?* Hubungi @Qiventorie untuk bantuan~
  `,
...
_Coba lagi nanti ya~_ (・ω<)${supportFooter}
  `,
...
_Harap tunggu sebentar ya~_ (＞﹏＜)${supportFooter}
  `,
...
_Tetap mencoba grup lainnya..._${supportFooter}
  `,
...
_Gomennasai, Senpai..._ (╥﹏╥)${supportFooter}
  `,
...
Session sudah dihapus dari database! ${getRandomKawaii()}${supportFooter}
  `,
...
*🆘 Butuh Bantuan?*
Hubungi @Qiventorie jika mengalami masalah atau bug!
...
_Hubungi @Qiventorie untuk mendapatkan akses~_
  `,
...
*Sudah join tapi masih muncul pesan ini?* 
Hubungi @Qiventorie untuk bantuan!
  `,
